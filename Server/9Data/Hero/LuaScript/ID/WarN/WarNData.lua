...
TrapDataTable =
{
	T_DT_S_FDHoneying = { SkillIndex = "SW_S_FDHoneying_Skill01_N", Interval = 0.1, },
	T_DT_S_IDHoneying = { SkillIndex = "SW_S_IDHoneying_Skill01_N", Interval = 0.1, },
	T_DT_S_SDHoneying = { SkillIndex = "SW_S_SDHoneying_Skill01_N", Interval = 0.1, },
	T_DT_S_TDHoneying = { SkillIndex = "SW_S_TDHoneying_Skill01_N", Interval = 0.1, },
}

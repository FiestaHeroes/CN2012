...
STATIC_DAMAGE = {}
STATIC_DAMAGE[Fig]  = 240
STATIC_DAMAGE[Cle]  = 280
STATIC_DAMAGE[Arc]  = 160
STATIC_DAMAGE[Mag]  = 120
STATIC_DAMAGE[Jok]  = 200
...
KD_END_LINKTO["Index"] = "RouN"
KD_END_LINKTO["x"] = 6708
KD_END_LINKTO["y"] = 8605
--[[*****																*****]]--
--[[*****					플레이어 세팅 관련 데이터					*****]]--
--[[*************************************************************************]]--
...
MobSettingTypeTable =
{
	Slime           = { Index = "MineSlime",        Demage = 40,    HP =   90,     HPRegen =   10,   AC =    9999, MR =    1000, Speed = 50,  Exp = 1, ItemDrop = 0, },
	EscortSlime     = { Index = "MineSlime",        Demage = 50,    HP =   95,     HPRegen =   12,   AC =    9999, MR =    1000, Speed = 50,  Exp = 1, ItemDrop = 0, },
	Honeying        = { Index = "MineHoneying",     Demage = 45,    HP =   110,    HPRegen =   16,   AC =    9999, MR =    1000, Speed = 50,  Exp = 1, ItemDrop = 0, },
	EscortHoneying  = { Index = "MineHoneying",     Demage = 55,    HP =   110,    HPRegen =   22,   AC =    9999, MR =    1000, Speed = 50,  Exp = 1, ItemDrop = 0, },
	Pinky           = { Index = "MinePinky",        Demage = 160,   HP =   200,    HPRegen =   28,   AC =    9999, MR =    1000, Speed = 50,  Exp = 1, ItemDrop = 0, },
	Kebing          = { Index = "MineKebing",       Demage = 70,    HP =   240,    HPRegen =   28,   AC =    9999, MR =    1000, Speed = 50,  Exp = 1, ItemDrop = 0, },
	EscortKebing    = { Index = "MineKebing",       Demage = 80,    HP =   260,    HPRegen =   32,   AC =    9999, MR =    1000, Speed = 50,  Exp = 1, ItemDrop = 0, },
	Boogy           = { Index = "MineBoogy",        Demage = 90,    HP =   280,    HPRegen =   36,   AC =    9999, MR =    1000, Speed = 50,  Exp = 1, ItemDrop = 0, },
	Crab            = { Index = "MineCrab",         Demage = 100,   HP =   300,    HPRegen =   40,   AC =    9999, MR =    1000, Speed = 50,  Exp = 1, ItemDrop = 0, },
	EscortCrab      = { Index = "MineCrab",         Demage = 120,   HP =   340,    HPRegen =   45,   AC =    9999, MR =    1000, Speed = 50,  Exp = 1, ItemDrop = 0, },
	Monkey_Boss     = { Index = "MineMonkey_Boss",  Demage = 1000,  HP =   2000,   HPRegen =   120,  AC =    9999, MR =    9999, Speed = 100, Exp = 1, ItemDrop = 0, },
	S_Kebing        = { Index = "MineS_Kebing",     Demage = 150,   HP =   400,    HPRegen =   60,   AC =    9999, MR =    1000, Speed = 50,  Exp = 1, ItemDrop = 0, },
	EscortS_Kebing  = { Index = "MineS_Kebing",     Demage = 150,   HP =   400,    HPRegen =   60,   AC =    9999, MR =    1000, Speed = 50,  Exp = 1, ItemDrop = 0, },
	KingBoogy       = { Index = "MineKingBoogy",    Demage = 180,   HP =   460,    HPRegen =   66,   AC =    9999, MR =    1000, Speed = 50,  Exp = 1, ItemDrop = 0, },
	Rock            = { Index = "MineRock",         Demage = 200,   HP =   500,    HPRegen =   80,   AC =    9999, MR =    1000, Speed = 60,  Exp = 1, ItemDrop = 0, },
	EmperorCrab     = { Index = "MineEmperorCrab",  Demage = 500,   HP =   1000,   HPRegen =   200,  AC =    9999, MR =    1000, Speed = 50,  Exp = 1, ItemDrop = 0, },
	StoneGolem      = { Index = "MineStoneGolem",   Demage = 600,   HP =   3000,   HPRegen =   240,  AC =    9999, MR =    9999, Speed = 80,  Exp = 1, ItemDrop = 0, },
	FireGolem       = { Index = "MineFireGolem",    Demage = 800,   HP =   5000,   HPRegen =   320,  AC =    9999, MR =    9999, Speed = 80,  Exp = 1, ItemDrop = 0, },
	IronGolem       = { Index = "MineIronGolem",    Demage = 1000,  HP =   8000,   HPRegen =   400,  AC =    9999, MR =    9999, Speed = 100, Exp = 1, ItemDrop = 0, },
	IceViVi         = { Index = "MineIceViVi",      Demage = 1,     HP =   1000,   HPRegen =   200,  AC =    9999, MR =    9999, Speed = 60,  Exp = 1, ItemDrop = 0, },
	FireViVi        = { Index = "MineFireViVi",     Demage = 1,     HP =   1000,   HPRegen =   200,  AC =    9999, MR =    9999, Speed = 60,  Exp = 1, ItemDrop = 0, },
	MineCar         = { Index = "MineCar",          Demage = 500,   HP =   1000,   HPRegen =   300,  AC =    9999, MR =    9999, Speed = 50,  Exp = 1, ItemDrop = 0, },
	MineCarHard     = { Index = "MineCar",          Demage = 1000,  HP =   5000,   HPRegen =   500,  AC =    9999, MR =    9999, Speed = 60,  Exp = 1, ItemDrop = 0, },
}
...
WaveMobTypeTable =
{
	...
	W_1_Pinky            = { MobSettingType = "Pinky",       BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "None",  MapMarkType = "Normal",    },
	W_1_1_MineCar        = { MobSettingType = "MineCar",     BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "EG_Honeying",  MapMarkType = "Normal",    },

	W_1_Crab             = { MobSettingType = "Crab",        BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "None",         MapMarkType = "Normal",    },
	W_1_2_MineCar        = { MobSettingType = "MineCar",     BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "None",         MapMarkType = "Normal",    },
	W_1_EmperorCrab      = { MobSettingType = "EmperorCrab", BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "EG_Crab",      MapMarkType = "Normal",    },

	W_1_3_MineCar        = { MobSettingType = "MineCar",     BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "EG_S_Kebing",    MapMarkType = "Normal",    },
	W_1_KingBoogy        = { MobSettingType = "KingBoogy",   BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "None",        MapMarkType = "Normal",    },


	W_2_1_KingBoogy      = { MobSettingType = "KingBoogy",   BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "None",    MapMarkType = "Normal",    },
	...
	W_2_1_MineCar        = { MobSettingType = "MineCar",     BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "EG_S_Kebing",    MapMarkType = "Normal",    },

	W_2_2_EmperorCrab    = { MobSettingType = "EmperorCrab", BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "EG_Crab",     MapMarkType = "Normal",    },
	...
	W_2_2_MineCar        = { MobSettingType = "MineCar",     BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "None",     MapMarkType = "Normal",    },

	W_2_3_Honeying       = { MobSettingType = "Honeying",       BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "EG_Honeying", MapMarkType = "Normal",    },
	W_2_3_MineCar        = { MobSettingType = "MineCar",     BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "EG_IceViVi",  MapMarkType = "Normal",    },
	...
	W_2_3_1_MineCar      = { MobSettingType = "MineCar",     BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "EG_FireViVi", MapMarkType = "Normal",    },
	...
	W_4_1_1_MineCar      = { MobSettingType = "MineCar",     BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "EG_IceViVi",  MapMarkType = "Normal",    },
	W_4_1_2_MineCar      = { MobSettingType = "MineCar",     BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "EG_FireViVi", MapMarkType = "Normal",    },

	W_4_2_MineCar        = { MobSettingType = "MineCar",     BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "EG_Crab",     MapMarkType = "Normal",    },
	...
	W_4_3_1_MineCar      = { MobSettingType = "MineCar",     BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "None",    MapMarkType = "Normal",    },
	W_4_3_KingBoogy      = { MobSettingType = "KingBoogy",   BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "EG_S_Kebing",    MapMarkType = "Normal",    },
	W_4_3_2_MineCar      = { MobSettingType = "MineCar",     BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "EG_IceViVi",  MapMarkType = "Normal",    },

	W_5_1_MineCar        = { MobSettingType = "MineCar",     BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "EG_Kebing",   MapMarkType = "Normal",    },
	W_5_1_S_Kebing       = { MobSettingType = "S_Kebing",    BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "None",   MapMarkType = "Normal",    },
	W_5_1_Slime          = { MobSettingType = "Slime",       BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "None",    MapMarkType = "Normal",    },

	W_5_2_MineCar        = { MobSettingType = "MineCar",     BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "EG_Crab",     MapMarkType = "Normal",    },
	W_5_2_EmperorCrab    = { MobSettingType = "EmperorCrab", BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "EG_Honeying", MapMarkType = "Normal",    },

	W_5_3_MineCar        = { MobSettingType = "MineCar",     BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "None",        MapMarkType = "Normal",    },
	W_5_3_StoneGolem     = { MobSettingType = "StoneGolem",  BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "None",        MapMarkType = "Chief",    },
	W_5_3_Rock           = { MobSettingType = "Rock",        BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "None",        MapMarkType = "Chief",    },
	...
	W_7_1_MineCar        = { MobSettingType = "MineCar",     BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "None",        MapMarkType = "Normal",    },
	...
	W_7_2_MineCar        = { MobSettingType = "MineCar",     BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "None",        MapMarkType = "Normal",    },
	...
	W_7_3_MineCar        = { MobSettingType = "MineCarHard",     BoomType = "None",     ResistType = "Normal",   SummonType = "None",          EscortGroupType = "None",        MapMarkType = "Normal",    },
...
BalanceTable =
{
	{ BalanceValue =   50, DamageRate = 1000, SpeedRate = 1000, HPRate = 1000, },
	{ BalanceValue =  100, DamageRate = 1000, SpeedRate = 1000, HPRate = 1200, },
	{ BalanceValue =  150, DamageRate = 1000, SpeedRate = 1000, HPRate = 1500, },
	{ BalanceValue = 1000, DamageRate = 1000, SpeedRate = 1100, HPRate = 2000, },
	{ BalanceValue = 1500, DamageRate = 1000, SpeedRate = 1200, HPRate = 4000, },
	{ BalanceValue = 2000, DamageRate = 1100, SpeedRate = 1300, HPRate = 6000, },
	{ BalanceValue = 2500, DamageRate = 1200, SpeedRate = 1400, HPRate = 7000, },
	{ BalanceValue = 3000, DamageRate = 1300, SpeedRate = 1500, HPRate = 9000, },
}
--[[*****																*****]]--
--[[*****				인원수 및 캐릭터 벨런스 관련 데이터				*****]]--
--[[*************************************************************************]]--
...
MineTable =
{
	MineMelee = { MobIndex = "MineMelee", ItemID = 58323, Skill = "MineMelee_W", Dist = 0, HitTime = 5, LifeTime = 7, Damage = 1000, Range = 100, AbstateType = "None",     },
	MineRange = { MobIndex = "MineRange", ItemID = 58324, Skill = "MineRange_W", Dist = 0, HitTime = 5, LifeTime = 7, Damage = 500, Range = 200, AbstateType = "None",     },
	MineIce   = { MobIndex = "MineIce"  , ItemID = 58325, Skill = "MineIce_W",   Dist = 0, HitTime = 5, LifeTime = 7, Damage =  50, Range = 200, AbstateType = "MineIce",  },
	MineStun  = { MobIndex = "MineStun" , ItemID = 58326, Skill = "MineStun_W",  Dist = 0, HitTime = 5, LifeTime = 7, Damage = 100, Range = 200, AbstateType = "MineStun", },
}
--[[*****																*****]]--
--[[*****						지뢰 아이템 관련 데이터					*****]]--
--[[*************************************************************************]]--
